...
void mapFlex()
{
   Pulgar = analogRead(A5);//Declaramos Pulgar para que lea el A5
   Pulgar = map (Pulgar, 530, 815, 10, 90);//Mapeo del Pulgar
   ...
   Indice = analogRead(A4);//Declaramos Indice para que lea el A4
   Indice = map (Indice, 540, 815, 10, 90);//Mapeo del Indice
   ...
   Corazon = map (Corazon, 540, 815, 10, 90);//Mapeo del Corazon
   ...
   Anular = analogRead(A2);//Declaramos Anular para que lea el A2
   Anular = map (Anular, 590, 820, 10, 90);//Mapeo del Anular
   ...
   Menique = analogRead(A1);//Declaramos Menique para que lea el A1
   Menique = map (Menique, 550, 850, 10, 90);//Mapeo del Menique
